...
INITIAL_DRONE_POS_FILE = r'C:\Users\cgadmin\Desktop\charlie-mnemonic-dev\charlie-mnemonic-dev\Data\charlie_shared_data\initial_drone_pos.json'  # to do: change this to the correct path

# this is where charlie stores the positions (of one step)
DRONE_POS_FILE = r'C:\Users\cgadmin\Desktop\charlie-mnemonic-dev\charlie-mnemonic-dev\Data\charlie_shared_data\drone_pos.json'   # to do: change this to the correct path
...
# Target positions are stored in this file
TARGET_POS_FILE = r'C:\Users\cgadmin\Desktop\charlie-mnemonic-dev\charlie-mnemonic-dev\Data\other_data\target_positions.json' # to do: change this to the correct path
